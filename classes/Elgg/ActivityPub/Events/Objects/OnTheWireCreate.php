	...
	public function __invoke(\Elgg\Event $event) {
		...
		if (!$object->save()) {
			if ((bool) elgg_get_plugin_setting('log_general_inbox_error', 'activitypub')) {
				$this->log(elgg_echo('activitypub:object:save:error', ['Event: OnTheWireCreate, Object GUID: ' . (int) $object->guid]), 'log_general_inbox_error');
			}
			return false;
		}
