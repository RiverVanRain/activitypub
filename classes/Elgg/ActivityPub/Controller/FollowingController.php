...
class FollowingController
{
    ...
    public function __invoke(\Elgg\Request $request): \Elgg\Http\Response
    {
        ...
        try {
            ...
            elgg_log('Following routing callback error: ' . $e->getMessage(), \Psr\Log\LogLevel::ERROR);
    ...
    protected function getCollectionInfo(\ElggUser|\ElggGroup $entity): array
    {
        ...
        $url = $entity instanceof \ElggUser ? elgg_generate_url('view:activitypub:user:following', [
            'guid' => (int) $entity->guid,
        ]) : elgg_generate_url('view:activitypub:group:following', [
            'guid' => (int) $entity->guid,
        ]);
